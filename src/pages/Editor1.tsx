...
const uploadToCloudinary = async (canvas: HTMLCanvasElement) => {
  ...
  return data.imageUrl; // 🔹 Doit correspondre à res.json({ imageUrl }) côté backend
};
...
// Nouvelle version de downloadMeme
const downloadMeme = async () => {
  ...
  try {
    ...
    // Étape 2 : Téléchargement local du meme
    const link = document.createElement("a");
    link.href = canvas.toDataURL("image/png");
    link.download = "meme.png"; // Nom du fichier téléchargé
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);

    // Étape 3 : Sauvegarde dans localStorage
    ...
    // Étape 4 : Afficher le lien Cloudinary dans la page
    const cloudinaryLink = document.createElement("a");
    cloudinaryLink.href = imageUrl;
    cloudinaryLink.target = "_blank";
    cloudinaryLink.textContent = "🌐 Voir votre meme sur Cloudinary";
    cloudinaryLink.style.display = "block";
    cloudinaryLink.style.marginTop = "10px";
    document.body.appendChild(cloudinaryLink);
